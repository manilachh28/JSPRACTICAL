...
async function configureOnce(options) {
    ...
    await (0, testcafe_1.ClientFunction)(new Function(content))();
}
...
const withWithinMethods = (selector) => {
...
function within(selector) {
    ...
    if (isSelector(selector)) {
        ...
        return within((0, testcafe_1.Selector)(selector));
    }
    else {
...
const bindFunction = (queryName) => {
    ...
    return (matcher, options) => {
        return (0, testcafe_1.Selector)(() => window.TestingLibraryDom[query](document.body, matcher, options), {
